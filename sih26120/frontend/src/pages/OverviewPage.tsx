...
import { AsphaltenePanel } from "../components/AsphaltenePanel";
...
export function OverviewPage({ data, wellId }: Props) {
  ...
  return (
    <div className="fade-in space-y-14 pb-12">
      ...
      <DynagraphPanel wellId={wellId} />
      <ThermalCouplingPanel wellId={wellId} />
      <AsphaltenePanel wellId={wellId} />
      <ControlGatewayPanel wellId={wellId} />
