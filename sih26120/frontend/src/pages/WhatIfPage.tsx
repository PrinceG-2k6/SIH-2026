...
import { DynagraphPanel } from "../components/DynagraphPanel";
import { ThermalCouplingPanel } from "../components/ThermalCouplingPanel";
import { ControlGatewayPanel } from "../components/ControlGatewayPanel";
...
export function WhatIfPage({ wellId, dashboard }: Props) {
  ...
  return (
    <div className="fade-in space-y-8">
      ...
      <DynagraphPanel wellId={wellId} parameters={params} className="mt-8" />
      <ThermalCouplingPanel wellId={wellId} parameters={params} className="mt-8" />
      <ControlGatewayPanel wellId={wellId} parameters={params} className="mt-8" />
    </div>
  );
}
