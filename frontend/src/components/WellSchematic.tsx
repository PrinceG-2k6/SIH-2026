...
export function WellSchematic({ state }: { state: TwinState }) {
  ...
  return (
    <svg viewBox="0 0 320 480" className="h-full w-full bg-[#F9F9F7]" role="img" aria-label="Well schematic">
      <defs>
        <radialGradient id="heatGradNewsprint" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#CC0000" stopOpacity={0.25 + heat * 0.4} />
          <stop offset="70%" stopColor="#CC0000" stopOpacity={0.08} />
      ...
      <line x1="6" y1="6" x2="26" y2="6" stroke="#CC0000" strokeWidth="3" />
      <line x1="6" y1="6" x2="6" y2="26" stroke="#CC0000" strokeWidth="3" />
      <line x1="314" y1="474" x2="294" y2="474" stroke="#CC0000" strokeWidth="3" />
      <line x1="314" y1="474" x2="314" y2="454" stroke="#CC0000" strokeWidth="3" />
      ...
      <text x="22" y="36" fill="#737373" fontSize="7" fontFamily="JetBrains Mono, monospace">
        BAGHEWALA CSS THERMAL CROSS-SECTION · NOT OIL-CALIBRATED
      </text>

      {/* Surface Equipment — Pumpjack */}
      <g transform="translate(48,42)">
        <rect x="0" y="78" width="88" height="8" fill="#F0F0EC" stroke="#111111" strokeWidth="1.5" />
        <rect x="8" y="70" width="28" height="16" fill="#FFFFFF" stroke="#111111" strokeWidth="1" />
        <text x="22" y="81" textAnchor="middle" fill="#111111" fontSize="6" fontFamily="JetBrains Mono, monospace" fontWeight="bold">
          GEARBOX
        </text>
        {/* Samson Post */}
        <polygon points="54,18 48,78 60,78" fill="#FFFFFF" stroke="#111111" strokeWidth="1.5" />
        {/* Beam + Horsehead */}
        <g transform={`rotate(${horseAngle} 54 28)`}>
          ...
          <circle cx="54" cy="28" r="4" fill="#FFFFFF" stroke="#111111" strokeWidth="2" />
        </g>
        {/* Counterweight */}
        <circle cx="22" cy="72" r="12" fill="none" stroke="#111111" strokeWidth="2" />
        <circle cx="22" cy="72" r="4" fill="#CC0000" />
        {/* Polish Rod */}
        <line
          x1="112"
          y1={20 + strokeAmp * 4}
      ...
      <g transform="translate(148,118)">
        <rect x="0" y="0" width="24" height="18" fill="#FFFFFF" stroke="#111111" strokeWidth="1.5" />
        <rect x="4" y="-8" width="16" height="8" fill="#F0F0EC" stroke="#111111" strokeWidth="1" />
        <rect x="24" y="6" width="22" height="5" fill="#111111" />
        <rect x="-18" y="6" width="18" height="5" fill="#111111" />
        <circle cx="36" cy="2" r="4" fill="#FFFFFF" stroke="#111111" strokeWidth="1" />
      ...
      <rect x="36" y="168" width="168" height="250" fill="#FFFFFF" stroke="#111111" strokeWidth="1" />
      ...
      <text x="44" y="186" fill="#737373" fontSize="7" fontFamily="JetBrains Mono, monospace" fontWeight="bold">
        OVERBURDEN SHALE
      </text>
      <line x1="44" y1="248" x2="120" y2="248" stroke="#111111" strokeWidth="1" strokeDasharray="3 2" />
      <text x="44" y="262" fill="#CC0000" fontSize="8" fontFamily="JetBrains Mono, monospace" fontWeight="bold">
        PAY · JODHPUR SANDSTONE
      </text>
      <text x="44" y="400" fill="#737373" fontSize="7" fontFamily="JetBrains Mono, monospace" fontWeight="bold">
      ...
      {/* Casing String */}
      <rect x="152" y="136" width="16" height="282" fill="#FFFFFF" stroke="#111111" strokeWidth="1.5" />
      <rect x="157" y="136" width="6" height="282" fill="#111111" />

      {/* Rod Couplings */}
      {[180, 230, 280, 330, 380].map((y) => (
        <rect key={y} x="150" y={y} width="20" height="4" fill="#CC0000" />
      ))}

      {/* Steam / Oil Perforations */}
      {[268, 278, 288, 298].map((y) => (
        <g key={y}>
          <line x1="140" y1={y} x2="152" y2={y} stroke="#CC0000" strokeWidth="2.5" />
          <line x1="168" y1={y} x2="180" y2={y} stroke="#CC0000" strokeWidth="2.5" />
        </g>
      ))}

      {/* Surface Production Tank */}
      <path d="M172 128 L250 128 L250 200" fill="none" stroke="#111111" strokeWidth="2" />
      <rect x="236" y="200" width="40" height="72" fill="#FFFFFF" stroke="#111111" strokeWidth="1.5" />
      <rect x="240" y="204" width="32" height="8" fill="#F0F0EC" stroke="#111111" strokeWidth="1" />
      <text x="256" y="238" textAnchor="middle" fill="#525252" fontSize="7" fontFamily="JetBrains Mono, monospace" fontWeight="bold">
        OFFTAKE
      </text>
      ...
      <text x="256" y="264" textAnchor="middle" fill="#737373" fontSize="6" fontFamily="JetBrains Mono, monospace">
        BOPD
      </text>

      {/* Callout Box */}
      <rect x="214" y="300" width="92" height="106" fill="#FFFFFF" stroke="#111111" strokeWidth="1.5" />
      <rect x="214" y="300" width="92" height="16" fill="#111111" />
      <text x="260" y="311" textAnchor="middle" fill="#F9F9F7" fontSize="7" fontFamily="JetBrains Mono, monospace" fontWeight="bold">
        TELEMETRY SPEC
      </text>
      <g fontFamily="JetBrains Mono, monospace" fontSize="8" fill="#111111">
        ...
        <text x="222" y="396" fill={risk ? "#CC0000" : "#1b6a38"} fontWeight="bold">
